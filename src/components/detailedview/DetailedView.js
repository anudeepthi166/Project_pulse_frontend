...
import ProjectUpdates from "../projectupdtes/ProjectUpdates";
    ...
    <div>
      ...
      <div className="row ps-3 container mx-auto  justify-content-around  mt-4 ">
        ...
        <div className="card col-sm-6 col-md-5 col-lg-3 ">
          <div className="card-title pt-3 ps-2">Project Status</div>
          <div className="card-body">{projectDetails.projectStatus}</div>
        </div>
        ...
        {/* Team Count */}
        <div className="card col-sm-6 col-md-5 col-lg-3">
          <div className="card-title pt-3 ps-2">Team Count</div>
          <div className="card-body ">
